    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>" class="default-color"><?php echo e(trans('main_trans.Home')); ?></a></li>
...
<?php /**PATH E:\laravel\moh\resources\views/layouts/master.blade.php ENDPATH**/ ?>