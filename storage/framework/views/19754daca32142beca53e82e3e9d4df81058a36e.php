...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('/dashboard')); ?>"><?php echo e($setting->title); ?></a>
        <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('/dashboard')); ?>"><?php echo e($setting->title); ?></a>
    ...
    <ul class="nav navbar-nav ml-auto">
        <li class="nav-item dropdown ">
            <a class="nav-link top-nav" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                aria-expanded="true"> <i class=" ti-flag-alt"></i> </a>
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                    onclick="event.preventDefault();
                     ...
                     </i><span class="text-dark ti-shift-left"> <?php echo e(trans('main_trans.Logout')); ?></span>
                 </a>
...
<!--=================================
header End-->
<?php /**PATH E:\laravel\moh\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>